  ...
  const handleComplete = async () => {
    if (selectedQualities.length === 5) {
      ...
      try {
        ...
        await updateUserData({ desired_qualities: qualitiesWithOrder });
        // Complete onboarding, navigate to profile
        navigate("/profile");
      } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-4xl mx-auto space-y-8 pt-16">
        ...
        <div className="text-center space-y-4">
          <h1 className="text-4xl font-bold text-foreground">
            What qualities do you most hope to collaborate with in others?
          </h1>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Select exactly 5 qualities you value most in a cofounder
          </p>
        </div>
